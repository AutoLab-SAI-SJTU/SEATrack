...
def create_default_local_file_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'got10k_val_dir': os.path.join(data_dir, 'GOT-10k/val'),
        ...
        'lasot_dir': os.path.join(data_dir, 'LaSOT/LaSOTBenchmark'),
        'got10k_dir': os.path.join(data_dir, 'GOT-10k/train'),
        ...
        'visevent_dir': os.path.join(data_dir, 'VisEvent/train_subset'),
    })
