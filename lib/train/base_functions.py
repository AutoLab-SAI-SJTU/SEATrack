...
def build_dataloaders(cfg, settings):
    ...
    data_processing_train = processing.seatrackProcessing(search_area_factor=search_area_factor,
                                                       output_sz=output_sz,
    ...
    data_processing_val = processing.seatrackProcessing(search_area_factor=search_area_factor,
                                                     output_sz=output_sz,
                                                     center_jitter_factor=settings.center_jitter_factor,
                                                     scale_jitter_factor=settings.scale_jitter_factor,
                                                     mode='sequence',
