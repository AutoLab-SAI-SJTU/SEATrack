...
cfg.MODEL.AMGLORA_RANK = 8
cfg.MODEL.HMOE_RANK = 4
cfg.MODEL.DETERMINISTIC_LORA_INIT = False
cfg.MODEL.AMG_ENABLED = True
cfg.MODEL.HMOE_ENABLED = True

# MODEL.BILIFT
cfg.MODEL.BILIFT = edict()
cfg.MODEL.BILIFT.ENABLED = False
cfg.MODEL.BILIFT.LAYERS = [5, 9]
cfg.MODEL.BILIFT.RANK = 8
cfg.MODEL.BILIFT.DROPOUT = 0.0
cfg.MODEL.BILIFT.DIAGNOSTICS = False

# MODEL.GRA
cfg.MODEL.GRA = edict()
cfg.MODEL.GRA.ENABLED = False
cfg.MODEL.GRA.DIAGNOSTICS = False
cfg.MODEL.GRA.LAYERS = [1, 3, 5, 7, 9, 11]
cfg.MODEL.GRA.RGAE_ENABLED = True
cfg.MODEL.GRA.RHO_MIN = 0.1
cfg.MODEL.GRA.DETACH_RHO = False
cfg.MODEL.GRA.USE_PROXY = False
cfg.MODEL.GRA.SPARSE = edict()
cfg.MODEL.GRA.SPARSE.ENABLED = False
cfg.MODEL.GRA.SPARSE.KEEP_RATIO = 1.0
cfg.MODEL.GRA.SPARSE.MIN_KEEP_RATIO = 0.5
cfg.MODEL.GRA.SPARSE.SHARED_MASK = True
cfg.MODEL.GRA.MOE = edict()
cfg.MODEL.GRA.MOE.TRUST_BIAS = False
cfg.MODEL.GRA.MOE.TOPK = None
cfg.MODEL.GRA.MOE.HIGH_RESPONSE_ONLY = False
...
cfg.TRAIN.PROMPT.TYPE = 'apt'  # seatrack_deep seatrack_shaw
cfg.TRAIN.LR = 0.0001
